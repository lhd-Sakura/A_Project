...
extern uint32_t speed_FL,speed_BL,speed_FR,speed_BR;
...
int16_t motor_driver::get_tick_inc()
{
	...
	{
		case 1:
			tick_cur = speed_FL;//获取tick值
			break;
		case 2:
			tick_cur = speed_BL;//获取tick值
			break;
		case 3:
			tick_cur = speed_FR;//获取tick值
			break;
		case 4:
			tick_cur = speed_BR;//获取tick值
			break;
	}
